...
class TweetManager:
	...
	def getJsonReponse(tweetCriteria, refreshCursor, cookieJar):
		url = "https://twitter.com/i/search/timeline?f=tweets&lang=en&q=%s&src=typd&max_position=%s"
		...
		if hasattr(tweetCriteria, 'topTweets'):
			if tweetCriteria.topTweets:
				url = "https://twitter.com/i/search/timeline?lang=en&q=%s&src=typd&max_position=%s"
